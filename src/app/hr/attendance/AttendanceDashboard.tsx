        ...
        <div style={{ overflowX: 'auto' }}>
          <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left', minWidth: '800px' }}>
            <thead style={{ backgroundColor: 'var(--bg-main)' }}>
              <tr>
                {['Employee', 'Department', 'Status', 'Punch In', 'Punch Out', 'Total Hours', 'Mode'].map(h => (
            ...
            <tbody>
              {filteredLogs.length === 0 ? (
                <tr><td colSpan={7} style={{ padding: '3rem', textAlign: 'center', color: 'var(--text-muted)' }}>{loading ? 'Fetching attendance...' : 'No records found.'}</td></tr>
