    ...
    try {
      ...
      const res = await fetch('/api/hr/employees/create', {
        ...
        body: JSON.stringify({
          ...
          swapShiftEligible,
          dayShiftStart: swapShiftEligible ? dayShiftStart : ((formData.get('morningTime') as string) || '09:00'),
          dayShiftEnd: swapShiftEligible ? dayShiftEnd : ((formData.get('eveningTime') as string) || '18:00'),
